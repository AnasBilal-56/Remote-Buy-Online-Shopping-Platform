...
void ShoppingGallery::setupUi()
{
    ...
    btnBack->setFixedSize(100, 35);
    btnBack->setStyleSheet("background-color: #3498db; color: white; font-weight: bold;");

    connect(btnBack, &QPushButton::clicked, this, &ShoppingGallery::on_btnBack_clicked);
    ...
    // topLayout->addWidget(other widgets like title or search);
...
void ShoppingGallery::on_btnBack_clicked()
{
    // Emit signal to go back to Customer Menu
    emit goBackToMenu();
}